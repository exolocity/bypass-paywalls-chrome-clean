...
* If none of these work, you can submit an issue on [GitHub](https://github.com/bpc-clone/bypass-paywalls-chrome-clean/issues) or [X (DM)](https://twitter.com/Magnolia1234B).
